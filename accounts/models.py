...
class CustomUser(AbstractUser):
    ...
    iconimage = models.ImageField(
        verbose_name='アイコン画像', blank=True, null=True, default='images/customuser/iconimage/icon.png', upload_to=get_iconimage_path)
    homeimage = models.ImageField(
        verbose_name='ホーム画像', blank=True, null=True, default='images/customuser/homeimage/home.jpg', upload_to=get_homeimage_path)
